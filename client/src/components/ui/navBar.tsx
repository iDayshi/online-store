    ...
    <header className="text-gray-600 body-font ">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          <span className="text-xl rounded-lg px-3 py-2 text-orange-600 font-medium hover:bg-slate-100 hover:text-slate-900 hover:underline decoration-orange-500">
            <Link to={"/"}>Phones</Link>
          </span>
          <span className="text-xl rounded-lg px-3 py-2 text-orange-600 font-medium hover:bg-slate-100 hover:text-slate-900 hover:underline decoration-orange-500">
        ...
        {ifLoggedIn ? (
          ...
          <Link to="login">
            <h1 className="flex ml-auto text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded transform active:scale-95 transition-transform">
              Sign In
            </h1>
          </Link>
        )}
